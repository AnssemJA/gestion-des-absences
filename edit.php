...
<?php
        ...
        if (!empty($_POST)) {
            $gestion_absence->updateGestion_absences($_POST['id_emp'],$_POST['date'], $_POST['motif_absence'], $_POST['absence_justifie'], $_POST['absence_prevue'], $_POST['duree'],$_POST['id']);
            header('Location:tables.php?notif=update');
            exit();
        } else {
...
<!---->
      ...
      <center><h2> Editer l'absence </h2></center>
            ...
            <form action="" method="post">
                ...
                <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" value="<?= $data['id_emp'] ?>" required name="id_emp" class="form-control">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="date_absence1"><b>date absence :</b></label>
                            <input type="date" value="<?= $data['date'] ?>" required name="date" class="form-control">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="motif_absence2"><b>motif_absence :</b></label>
                            <input type="text" value="<?= $data['motif_absence'] ?>" required name="motif_absence" class="form-control">
                        </div>
                    </div>
               
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="absence_justifie3"><b>absence justifie :</b></label>
                            <input type="text" value="<?= $data['absence_justifie'] ?>" required name="absence_justifie" class="form-control">
                        </div>
                    </div>
                
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="absence_prevue4"><b>absence prevue :</b></label>
                            <input type="text" value="<?= $data['absence_prevue'] ?>" required name="absence_prevue" class="form-control">
                        </div>
                    </div>
                
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="duree5"><b>duree :</b></label>
                            <input type="texte" value="<?= $data['duree'] ?>" required name="duree" class="form-control">
                        </div>
                    </div>
                </div>
