        ...
        <div class="row">
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-primary o-hidden h-100">
              ...
              <a class="card-footer text-white clearfix small z-1" href="archiver.php">
                <span class="float-left">Voi les détails</span>
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-warning o-hidden h-100">
              <div class="card-body">
                ...
                <div class="mr-5">Imprimer !</div>
              </div>
              <a class="card-footer text-white clearfix small z-1" href="imprimer.php">
                <span class="float-left">Voi les détails</span>
                <span class="float-right">
                  <i class="fas fa-angle-right"></i>
                </span>
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-danger o-hidden h-100">
              <div class="card-body">
                ...
                <div class="mr-5">formulaire !</div>
              </div>
              <a class="card-footer text-white clearfix small z-1" href="create.php">
                <span class="float-left">Voi les détails</span>
                <span class="float-right">
                  <i class="fas fa-angle-right"></i>
                </span>
